        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <textarea name="address" rows="10" placeholder="Where to ?" class="input-responsive" required></textarea>
            ...
            <!---Stripe gateway--->
            <form action="submit.php" method="post" class="order">

            <script	src="https://checkout.stripe.com/checkout.js" class="stripe-button"
              data-key="<?php echo $publishableKey?>"
                data-amount="<?php echo $total?>"
                  data-name="Food Ordering Site"
                    data-description=""
                      data-image=""
                        data-currency="bdt"
                          >
